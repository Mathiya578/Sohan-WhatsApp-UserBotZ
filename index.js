...
async function startMiku() {
    ...
    console.log(color(figlet.textSync('SOHAN BOTZ MD', {
        font: 'Pagga',
    ...
    console.log(color('\nHello, I am Sohan, the main developer of this bot.\n\nThanks for using: Sohan Matheesha Bot made by Sohan.', 'sohan'))
    console.log(color('\nYou can follow me on GitHub: Mathiya578\n\n', 'sohan'))
    ...
    Miku.ev.on('connection.update', async (update) => {
        ...
        status = connection;
        if (connection) {
            await console.info(`SOHAN BOTZ Server Status => ${connection}`);
          }
